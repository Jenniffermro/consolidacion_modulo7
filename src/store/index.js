...
export default new Vuex.Store({
  ...
  getters: {
    total_cupos(state){
      return state.cursos.reduce((total,alumnos)=>total+alumnos.cupos,0)
    
    },
    total_inscritos(state){
      return state.cursos.reduce((total,inscritos)=>total+inscritos.inscritos,0)
    },
    total_restantes(state, getters){
      return getters.total_cupos-getters.total_inscritos
    },
    total_terminados(state){
